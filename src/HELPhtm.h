...
<html>
	...
	<body>
		...
		<ul>
		<li>
		<div>rollet = up/stop/down - відкрити, зупинити, закрити</div>
		</li>
		</ul>
		...
		<ul>
		<li>
		<div>ipStat - статична адреса</div>
		</li>
		<li>
		<div>protTime - час повного закриття/відкриття</div>
		</li>
		<li>
		<div>rfUp - радіо-код відкривання</div>
		</li>
		<li>
		<div>rfStop - радіо-код зупинки</div>
		</li>
		<li>
		<div>rfDown - радіо-код закривання</div>
		</li>
		</ul>
